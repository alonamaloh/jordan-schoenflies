...
\end{longtheorem}
\begin{proof}
Subdivide $C$ at $p,q$ --- which changes no parity function, by
Lemma~\ref{lem:parity-subdivision} --- and rotate coordinates so that no
edge of $C\cup P$ is horizontal. By Theorem~\ref{thm:polygonal-jordan}, the parity
...
Theorem~\ref{thm:polygonal-crosscut}\newline\emph{Two-sided polygonal crosscuts} & Lemma~\ref{lem:parity-subdivision}, Theorem~\ref{thm:polygonal-jordan} and Lemma~\ref{lem:polygon-parity} \\
